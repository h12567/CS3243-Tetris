public class Config {
    ...
    public static final int TURN_NUMBER_LIMIT = 100000;    // Set to -1 for unlimited
    public static final int TESTS_PER_GENERATION = 1;
    ...
    public static final String TRAINING_SEQUENCE = "training_seq.txt";
